...
def run_experiment(experiment_path: Path, workspace: Path, fallback_mode: str = "cpu") -> Path:
    ...
    # Standardized book shape for inspectable comparisons across experiments.
    profile.chapter_count = 5
    profile.subchapters_per_chapter = 10
    ...
    text = GenerationEngine().generate(
        GenerationRequest(
            ...
            subchapters_per_chapter=profile.subchapters_per_chapter,
