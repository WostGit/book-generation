...
BookLab is a modular, enterprise-style experimentation pipeline for end-to-end book generation, retrieval grounding (RAG), quality evaluation, and multi-format packaging. Each generated book is standardized to **5 chapters with 10 subchapters per chapter** for apples-to-apples comparison.
...
- **Inspectable artifacts**: CI uploads generated books under `.artifacts/books` plus full run bundles.
